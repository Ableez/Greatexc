...
const Footer = (props: Props) => {
  return (
    <div>
      <div className="bg-slate-100 w-full px-8 py-8 place-items-center grid text-sm text-left">
        <div className="max-w-screen-lg mx-auto">
          <h4 className="font-bold text-slate-400 w-full">
          ...
          <p className="my-4 text-slate-400">
            ...
            information over the phone or via email. We will never ask for your
            card&apos;s PIN. Be cautious of anyone claiming to represent our
            company who asks for this information. Remember, your gift
            card&apos;s security is in your hands. Stay vigilant to enjoy a
            worry-free gifting experience.
          </p>
        </div>
      </div>
      <footer className="bg-slate-100 sm:p-6 dark:bg-gray-800  py-16 border-t">
        <div className="max-w-screen-lg mx-auto">
          <div className="mx-auto max-w-screen-xl">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex mt-4 px-4 md:px-0 space-x-6 justify-center sm:mt-0">
                <a
                  href="#"
