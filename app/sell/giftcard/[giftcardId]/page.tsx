...
const GiftcardView = ({ params }: { params: { giftcardId: string } }) => {
  ...
  const handleAmount = (param: string) => {
    setSellingParams((prev) => {
      return {
        ...prev,
        amount: param,
  ...
  const customAmount = document.getElementById("cusomAmount");
      ...
      >
        ...
        <div className="place-items-center text-left">
          ...
          <div>
            ...
            <div>
              <div className="my-4">
                ...
                <div
                  className={`border border-neutral-200 rounded-2xl py-4 w- h-full text-neutral-600 hover:border-neutral-500 duration-300 text-xl placeholder:text-neutral-300 px-4 outline-none focus:outline-transparent focus:ring-0 ring-pink-200`}
                >
                  <h4>$</h4>
                  <input
                    type="number"
              ...
              <div>
                ...
                <h4
                  ...
                  style={{ fontWeight: "500" }}
                >
                  {customAmount && (("N" + sellingParams.amount) as any) * 1370}
                </h4>
              </div>
            </div>
          </div>
          ...
          >
            <Menu.Button
              disabled={
                sellingParams.amount === "" || sellingParams.channel === ""
              }
            ...
            <Menu.Items className={""}>
              <div className="fixed top-0 left-0 z-[999] h-screen w-full bg-pink-50 bg-opacity-30 backdrop-blur-md overflow-hidden grid place-items-center">
                <Transition
                  enterFrom="scale-0 duration-150"
                  enterTo="scale-100 duration-150"
                  leaveFrom="scale-100 duration-150"
                  leaveTo="scale-0 duration-150"
                >
                  <Menu.Button
                    className={
                      "absolute top-0 right-0 bg-pink-500 p-2 rounded-full float-right m-2"
                    }
                  >
                    <XMarkIcon width={23} color="#fff" />
                  </Menu.Button>
                  <div>
                    <h4 className="p-8 text-xl font-bold text-slate-900">
                      We will need your details to proceed
                    </h4>
                    <form
                      onSubmit={(e) => handleSubmit(e)}
                      className="space-y-4 md:space-y-6 bg-white p-8"
                      action="#"
                    >
                      <div>
                        <label
